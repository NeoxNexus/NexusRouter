/**
 * Auto-update checker for NexusRouter.
 * Checks npm registry on startup and notifies user if update available.
 */

import { VERSION } from "./version.js";

const NPM_REGISTRY = "https://registry.npmjs.org/nexusrouter/latest";
const UPDATE_URL = "https://github.com/YOUR_ORG/NexusRouter/releases";
...
export async function checkForUpdates(): Promise<void> {
  try {
    ...
    if (compareSemver(latest, VERSION) > 0) {
      console.log("");
      console.log(`\x1b[33m⬆️  NexusRouter ${latest} available (you have ${VERSION})\x1b[0m`);
