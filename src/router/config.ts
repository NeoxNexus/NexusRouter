...
export const DEFAULT_ROUTING_CONFIG: RoutingConfig = {
  ...
  tiers: {
    ...
    COMPLEX: {
      ...
      fallback: [
        ...
        "deepseek/deepseek-chat",
        "xai/grok-4-0709",
        "openai/gpt-5.4", // Latest GPT-5 flagship
        "openai/gpt-4o",
  ...
  // Eco tier configs - absolute cheapest (eco profile)
  ecoTiers: {
    SIMPLE: {
  ...
  // Premium tier configs - best quality (premium profile)
  // gpt-5.4=latest flagship coding/analysis, kimi=simple coding,
  // sonnet=reasoning/instructions, opus=architecture/PM/audits
  premiumTiers: {
    SIMPLE: {
    ...
    MEDIUM: {
      primary: "openai/gpt-5.4", // Latest flagship coding/analysis model
      fallback: [
